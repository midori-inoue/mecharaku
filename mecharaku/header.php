...
})(window,document,'script','dataLayer','GTM-PZTQD9L7');</script>
<!-- End Google Tag Manager -->
<meta name="viewport" content="width=device-width,user-scalable=no,maximum-scale=1" />
<meta name="robots" content="noindex,nofollow" />
<title><?php wp_title( '|', true, 'right' ); bloginfo('name'); ?> | めちゃ楽PRINT</title>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PZTQD9L7"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
<header>
<div id="header_inner">
<div id="top_logo"><div id="logo"><a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri();?>/img/base/top_logo_b.png" width="562" height="170" alt="めちゃ楽PRINT　「困った」をなんとかする印刷サイト"/></a></div><div class="t_center"><figure><img src="<?php echo get_template_directory_uri();?>/img/base/top_logo_c.png" alt="最短出荷3営業日"/></figure><figure><img src="<?php echo get_template_directory_uri();?>/img/top/creditcard.png" alt="クレジットカード対応可"/><figcaption>その他：銀行振込・コンビニ払い・NP請求書払い</figcaption></figure></div></div>
<div  id="top_tel">
