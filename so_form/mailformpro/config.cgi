...
## フォームの宛先
push @mailto,'info@sakupuri.jp';

## 自動返信メールの差出人名
$config{'fromname'} = 'めちゃ楽PRINT';
...
$config{'ThanksPage'} = 'https://mecharaku.jp/so_thanks';

## 設置者に届くメールの件名
$config{'subject'} = '[ %s ] めちゃ楽PRINT　「そのままコース」フォームから';
...
$config{"ReturnSubject"} = '[ %s ] 「そのままコース」へのご依頼ありがとうございます';
...
この度はめちゃ楽PRINTに「そのままコース」へのご依頼ありがとうございます。

後日当社担当より原稿作成から印刷までのご案内をいたします。
ご希望のレイアウトをお聞きしますので、
見本の画像をご用意頂けますようお願い申し上げます。
...
送って頂いた個人情報については下記のページの内容に準じて厳重に管理致します。

利用規約：https://mecharaku.jp/rules/
特定取引法に基づく表記：https://mecharaku.jp/law/
個人情報の取り扱い：https://mecharaku.jp/policy/
情報セキュリティ基本方針：https://mecharaku.jp/security/
━━━━━━━━━━━━━━━━━━━━━━━━━━
　めちゃ楽PRINT
　富士高速印刷株式会社
　〒679-4232　兵庫県姫路市林田町上伊勢962-3
